...
mv /usr/share/nginx/html/carcierge-staging-architecture-aws/frontend/* /usr/share/nginx/html/
sudo rm -rf /usr/share/nginx/html/carcierge-staging-architecture-aws